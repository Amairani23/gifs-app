...
describe('SearchBar', () => {
    ...
    test('should render searchbar correctly', async() => {
      ...
      //si no es con snapshot, se puede el siguiente:
    ...
    test('should call onQuery with the correct value after 700ms', async () => {
      const onQuery = vi.fn();
        ...
        //si sale error es por el tiempo que se le ingreso
        //await new Promise((resolve) => setTimeout(resolve, 701)); o mejor
        await waitFor( () => {
    ...
    test('should the input has the correct placeholder value', () => {
      ...
      expect(screen.getByPlaceholderText(value));
    });
})